    ...
    <div className="border-t border-slate-800 bg-slate-900 p-3">
      ...
      {sessionExpired && (
        <div className="mb-2 flex items-center justify-between rounded-lg bg-amber-500/10 px-3 py-2">
          <p className="text-xs text-amber-400">
            Fenêtre de 24 h expirée. Utilisez un modèle pour relancer.
          </p>
          <Button
            variant="ghost"
            size="sm"
      ...
      <div className="flex items-end gap-2">
        ...
        <textarea
          ...
          placeholder={
            sessionExpired
              ? "Session expirée — utilisez un modèle"
              : "Tapez un message… (Maj+Entrée = nouvelle ligne)"
          }
      ...
      <p className="mt-1 pl-11 text-[10px] text-slate-600">
        Tapez « / » pour les réponses rapides
      </p>
    </div>
  );
}
