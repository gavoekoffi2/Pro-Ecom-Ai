-- ============================================================
-- Pro WhatsApp PDB — schéma complet (toutes les migrations)
--
-- Fichier généré : concatène supabase/migrations/*.sql dans
-- l'ordre. Collez TOUT ce fichier dans Supabase → SQL Editor
-- et cliquez sur RUN pour créer toutes les tables d'un coup.
-- (Équivaut à exécuter chaque migration numérotée à la suite.)
-- ============================================================
